...
class DropdownMenu extends React.PureComponent {
    ...
    render() {
        ...
        const menuTitle = children ||
            (menu.length > 0 && <a key="down">{this.props.intl.formatMessage({
                id: 'COMMON_DROPDOWN_MORE',
                defaultMessage: '更多'
            })}<Icon type="down"/></a>) ||
            (!this.props.hiddenIfEmpty && <a key="down" disabled>{this.props.intl.formatMessage({
                id: 'COMMON_DROPDOWN_MORE',
                defaultMessage: '更多'
            })}<Icon type="down"/></a>);
